  ...
  <main>
    <div class="container mt-2 mb-5">
      <div class="col-lg-12 text-light">
        <h1 class="text-center text-classy">Zero Corporation</h1>
        <h3 class="text-center zero-title mt-5">Our Motto</h3>
        <h5 class="text-center zero-title">"More Goals Reached, More Happiness Fulfilled."</h5>
        <h3 class="text-center zero-title mt-5">Our Vision</h3>
        <h5 class="text-center zero-title">"Become the Best Corporation and Brighten The Day of People in San Andreas."</h5>
        <h3 class="text-center zero-title mt-5">Our Mission</h3>
        <h5 class="text-center zero-title">"Providing reliable and simple financial solutions that are part of customers' lives."</h5>
        <h4 class="text-center zero-title my-5">Zero Corporation is one of the Business Company in Los Santos. We are engaged in Finance such as Lending Funds, Credit, and Investment. We are committed to advancing the welfare of the community by providing the best service and easy requirements. That way, we hope that people can live a better life.</h4>
